...
def update_chart(slider_range,site_dropdown):
    ...
    if site_dropdown == 'All sites' :
        first_filtered_df = spacex_df[Payload Mass (kg)] >= low and spacex_df[Payload Mass (kg)] =< high
        fig = px.scatter(first_filtered_df, x='Payload Mass (kg)', y ='class', color='Booster Version Category')
        return fig
    else:
            second_filtered_df = spacex_df[spacex_df['Launch Site'] == site_dropdown]
            fig = px.scatter(second_filtered_df, x='Payload Mass (kg)', y ='class', color='Booster Version Category')
            return fig
